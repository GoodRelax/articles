...
[2番？ 今取り組んでいるところ。](https://github.com/GoodRelax/gr-sw-maker)
...
👉 **[ANMS Template & Essay](https://github.com/GoodRelax/gr-sw-maker/tree/main/anms-template/)**

| ファイル | 内容 |
| ---- | -------- |
| [`anms-essay-ja.md`](https://github.com/GoodRelax/gr-sw-maker/tree/main/anms-template/anms-essay-ja.md) | エッセイ全文（日本語） |
| [`anms-spec-template-ja.md`](https://github.com/GoodRelax/gr-sw-maker/tree/main/anms-template/anms-spec-template-ja.md) | 仕様書テンプレート（日本語） |
| [`anms-essay-en.md`](https://github.com/GoodRelax/gr-sw-maker/tree/main/anms-template/anms-essay-en.md) | エッセイ全文（英語） — 既存フォーマットとの比較・根拠 |
| [`anms-spec-template-en.md`](https://github.com/GoodRelax/gr-sw-maker/tree/main/anms-template/anms-spec-template-en.md) | 仕様書テンプレート（英語） |
